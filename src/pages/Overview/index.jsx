      ...
      <div className="cardContent">
        <div className="od_performance">
          ...
          <div className="performance_progress">
            <div className="title">
              <h5>Overall Desktop Performance: <span>Average (78%)</span></h5>
            </div>
            <div className="p_bar">
              <div className="p_bg">
            ...
            <div className="progress_tiles">
              <div className="progress_tile1">
                ...
                <CircularProgress variant="determinate" className="MuiCircularProgress-colorPrimary" thickness={9} value={87} />
                </div>
              </div>
        ...
        <div className="od_performance">
          ...
          <div className="performance_progress">
            <div className="title mtitle">
              <h5>Overall Mobile Performance: <span>poor (26%)</span></h5>
            </div>
            <div className="p_bar">
              <div className="p_bg">
